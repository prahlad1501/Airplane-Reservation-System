...
char flightdata[] = "C:/Users/pranj/Desktop/Airline Reservation System (Customer Side)/release/Flight data.csv";
...
int MainWindow::display(struct LinkedListNode* head)
{
    ...
    else
    {
        ...
        while(temp->next!=NULL)
        {
            ...
            QString F = QString::number(temp->index);
            ui->tableWidget->setItem(ui->tableWidget->rowCount()-1,0,new QTableWidgetItem(F));
    ...
    , ui(new Ui::MainWindow)
{
    ...
    titles<<"Index"<<"Flight No."<<"Airline"<<"From"<<"To"<<"Date"<<"Time"<<"Price";
